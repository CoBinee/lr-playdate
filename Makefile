...
SRC = \
	...
	src/Application.c \
	src/Title.c \
	src/Logo.c src/Car.c src/Starter.c \
	src/Game.c \
	src/Player.c src/Enemy.c src/EnemyOfficer.c src/EnemyInspector.c src/EnemyDog.c src/Treasure.c src/Background.c src/Status.c src/Intro.c src/Result.c 
...
font:
	@tools/ttf2fnt -w=16 -h=16 -k=1 -white -o Source/fonts/misaki_gothic.fnt res/fonts/misaki_ttf_2021-05-05/misaki_gothic.ttf
